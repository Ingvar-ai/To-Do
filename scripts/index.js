...
const createTodo = (title, form, list) => {
    ...
    todoHeader.classList.add("text-center", "mb-5", "mt-5");
...
const createItemTodo = (item, listTodo) => {
    ...
    btnItem.classList.add("list-item",  "btn", "btn-block",
      "border-dark", "rounded-pill", item.success ? "btn-success" : "btn-light");
